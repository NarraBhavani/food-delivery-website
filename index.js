import {foodItem} from './onlinefooditem.js'
...
function displayItems(){
    ...
    function addToCart(){
       ...
       var itemToAdd= this.parentNode.nextSibling.nextSibling.
       innerText;
...
function incrementItem(){
    ...
    function decrementItem(){
        ...
        if(decObj.quantity > 1){
            currPrice= (decObj.price*decObj.quantity - decObj.price*(decObj.quantity-1))/
            (decObj.quantity);
            decObj.quantity-= 1;
